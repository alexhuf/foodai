...
def train_space(
    ...
    run_dir = project_root / "models" / "representation_v3_1" / space
    ensure_dir(run_dir)
...
def main():
    parser = argparse.ArgumentParser(description="Train representation encoders v3.1 with normalized regime regression heads.")
    ...
    ensure_dir(project_root / "models" / "representation_v3_1")
